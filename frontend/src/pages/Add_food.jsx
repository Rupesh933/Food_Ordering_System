  ...
  return (
    <AdminLayout>
      ...
      <div
        ...
        style={{ backgroundColor: "#eddba8" }}
      >
        <div className="col-md-8 p-4 shadow-sm rounded ">
          <h2 className="mb-4">
            <i className="fas fa-plus-circle text-primary me-1"></i>Add Food
            Item
          </h2>
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            <div className="mb-3">
              ...
              >
                ...
                {categories.map(
                  (cat) => (
                    <option key={cat.id} value={cat.id} required>
                      {cat.category_name}
                    </option>
                  ), // category access from id
                )}
              </select>
            </div>
        ...
        <div
          className="col-md-4 d-flex justify-content-center align-items-center rounded "
          style={{
            backgroundImage: 'url("/images/food_addJSX.jpg")',
