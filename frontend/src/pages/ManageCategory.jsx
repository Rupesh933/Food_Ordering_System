...
const ManageCategory = () => {
    ...
    const handleSearch = (search) =>{
        ...
        const filtered = allCategories.filter((cate) => cate.category_name.toLowerCase().includes(keyword))
    ...
    <AdminLayout>
        <div className=''>
            ...
            <h5 className='text-end text-muted'>
                <i className='fas fa-database'></i>Total Category
            ...
            <div className='mb-3 d-flex justify-content-between'>
                ...
                <CSVLink data={formattedData} className='btn btn-success' filename="category_list.csv"><i className='fas fa-file-csv me-2'></i>Export to</CSVLink>
            </div>
            ...
            <table className='table table-hover'>
                ...
                <tbody>
                    ...
                    <tr key={ cat.id }>
                        ...
                        <td>{new Date(cat.creation_date).toLocaleTimeString()}</td>
                        <td>
